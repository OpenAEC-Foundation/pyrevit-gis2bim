...
- [ ] **Fase 3 — JSON-export met constructies-lagen-koppeling** — rooms + constructies-met-lagen + grensvlakken met grenstype/naar_ruimte/azimuth/netto-opp + openingen; tool levert λ + glas-U. Robuustheids-stap: type-IDs tijdens raycast vastleggen i.p.v. naam-resolutie (naam-collisie over categorieën is nu benign maar volgorde-afhankelijk).
