...
- [ ] **Fase 3b — JSON-export builder** — `catalog_export.py` → ThermalImport JSON met rooms + constructies-met-lagen + grensvlakken (grenstype/naar_ruimte/azimuth/netto-opp) + openingen. Tool levert λ + glas-U. Type-IDs tijdens raycast vastleggen i.p.v. naam-resolutie.
