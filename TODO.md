...
- [ ] **Fase 3c — openingen in JSON-export** — `catalog_export.py` uitbreiden met openings-array: breedte/hoogte uit shape-geometrie + host-construction-koppeling voor correcte nesting in ThermalImport-schema.
