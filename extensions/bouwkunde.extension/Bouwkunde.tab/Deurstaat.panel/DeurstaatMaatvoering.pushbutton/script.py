...
Roept KozijnstaatMaatvoering.pushbutton.run("deur") aan via de gedeelde shim-loader.
...
__doc__ = "Plaats maatlijnen op deur-instances (deur-references via Config)"
...
if __name__ == "__main__":
    if revit.doc is None:
        ...
        run_shared("KozijnstaatMaatvoering.pushbutton", "deur")
