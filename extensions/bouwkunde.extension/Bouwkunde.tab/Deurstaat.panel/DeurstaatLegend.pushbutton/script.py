...
Roept KozijnstaatLegend.pushbutton.run("deur") aan via de gedeelde shim-loader.
...
__doc__ = "Genereer deur-legend-views (POC)"
...
if __name__ == "__main__":
    if revit.doc is None:
        ...
        run_shared("KozijnstaatLegend.pushbutton", "deur")
