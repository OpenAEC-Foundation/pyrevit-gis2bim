...
Roept KozijnstaatWizard.pushbutton.run("deur") aan via de gedeelde shim-loader.
...
__doc__ = "Doorloop de volledige Deurstaat-workflow"
...
if __name__ == "__main__":
    if revit.doc is None:
        ...
        run_shared("KozijnstaatWizard.pushbutton", "deur")
