...
Roept KozijnstaatRename.pushbutton.run("deur") aan via de gedeelde shim-loader.
...
__doc__ = "Hernoem deurtypes volgens 3BM-conventie"
...
if __name__ == "__main__":
    if revit.doc is None:
        ...
        run_shared("KozijnstaatRename.pushbutton", "deur")
